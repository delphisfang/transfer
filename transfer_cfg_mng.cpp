...
// default config
CTransferCfgMng::CTransferCfgMng()
{
...
int CTransferCfgMng::loadConfig()
{	
    CFileConfig page;
...
int32_t CTransferCfgMng::LoadConfCache(CFileConfig& page)
{
...
int CTransferCfgMng::GetDefault(CFileConfig& page, const string& key, int defval)
{
	try
	{
...
string CTransferCfgMng::GetDefault(CFileConfig& page, const string& key, const string& defval)
{
	try
	{
		return page[key];
...
// print import config 
string CTransferCfgMng::ToString()
{
	string ret = "\n-----------------config begin-------------------\n";	
	char buf[64];
...
int CTransferCfgMng::LoadCfg(const string& cfg_path)
{
	_config_path = cfg_path;
	return loadConfig();
}

int CTransferCfgMng::Reload()
{
	return loadConfig();
}
